...
// raise warn if boot address is not set
	...
	#warning IntroSatLib::EnterBootloader() not supported by selected package \
	         IntroSatLib::EnterBootloader() currently supports STM32F1xx, STM32F4xx, STM32H750xx and Atmega328p(b) \
             Calls to IntroSatLib::EnterBootloader() will have no effect
#endif
