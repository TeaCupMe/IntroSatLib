#ifndef ACCELEROMETERV1_H_
#define ACCELEROMETERV1_H_
...
class AccelerometerV1: protected I2CDevice {
...
public:
	 ...
	 */
	AccelerometerV1(interfaces::I2C i2c, uint8_t address = BASE_ADDRESS);
	 ...
	 */
	AccelerometerV1(const AccelerometerV1& other);
	AccelerometerV1& operator=(const AccelerometerV1& other);
	...
	AccelerometerV1(AccelerometerV1&& other);
	AccelerometerV1& operator=(AccelerometerV1&& other);
	...
	~AccelerometerV1() override;
};

} /* namespace IntroSatLib */

#endif /* ACCELEROMETERV1_H_ */
